...
const Home = ({ isLoggedIn, onLogout, location, setLocation }) => {
    ...
    const handleSubmit = async (value) => {
        ...
        const res = await fetch('/places/getList', { method: 'POST', credentials: 'include', headers: { 'Content-Type': 'application/json', }, body: JSON.stringify(location), });
    ...
    return (
        <div class="h-screen bg-pink-100">
            ...
            <h2 class="flex items-center justify-center text-4xl font-extrabold">veggie finder</h2>
